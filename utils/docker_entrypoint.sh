...
if [ -z ${GROUP_ID+x} ]; then GROUP_ID=1000; fi
  if [ -z ${AOSP_LUNCH_VARIANT+x} ]; then AOSP_LUNCH_VARIANT="aosp_bullhead-userdebug"; fi
...
echo "cd /aosp; source build/envsetup.sh; lunch $AOSP_LUNCH_VARIANT" >> /home/aosp/.bashrc
